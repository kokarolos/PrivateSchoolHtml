...
function readFormData() {
    ...
    formData["trainername"] = document.getElementById("trainername").value;
    return formData;
}
...
function insertNewRecord(data) {
    ...
    cell2.innerHTML = data.trainername;
...
function onEdit(td) {
    ...
    document.getElementById("trainername").value = selectedRow.cells[1].innerHTML;
}

//store updated data to array
function updateRecord(formData) {
    selectedRow.cells[0].innerHTML = formData.coursetitle;
    selectedRow.cells[1].innerHTML = formData.trainername;
}
